...
function CTASection() {
  ...
  return (
    <div className=" p-4 pb-6 justify-center bg-blue-50">
          ...
          <div>
            <div className="justify-center flex flex-col">
              ...
              <a
                ...
                className="bg-blue-600 px-4 py-2 w-34 text-center items-center text-h3 text-white rounded-xl shadow-2xl ml-4 mb-6 hover:bg-blue-700 "
              >
                Get Started
              </a>
            </div>
